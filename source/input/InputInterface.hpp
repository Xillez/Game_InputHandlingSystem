...
//
// Frontend: (EITHER)
// - Make a system (Value Modifier) where a setter is given and some basic info about functionality when something happens.
// OR
// - Make an context based system where anything that is within context takes keyinput.
// OR
// - Make a heavily integrated, not modularized system with bearly any abstraction what-so-ever
...
enum KeyValue { 
    ...
    GLFW_KEY_3 = 51, GLFW_KEY_4 = 52, GLFW_KEY_5 = 53, GLFW_KEY_6 = 54, GLFW_KEY_7 = 55, 
    GLFW_KEY_8 = 56, GLFW_KEY_9 = 57, GLFW_KEY_SEMICOLON = 59 /* ; */, GLFW_KEY_EQUAL = 61 /* = */, 
    ...
    GLFW_KEY_WORLD_1 = 161 /* non-US #1 */, GLFW_KEY_WORLD_2 = 162 /* non-US #2 */, 
    ...
    GLFW_KEY_F12 = 301, GLFW_KEY_F13 = 302, GLFW_KEY_F14 = 303, GLFW_KEY_F15 = 304, 
    GLFW_KEY_F16 = 305, GLFW_KEY_F17 = 306, GLFW_KEY_F18 = 307, GLFW_KEY_F19 = 308, 
    GLFW_KEY_F20 = 309, GLFW_KEY_F21 = 310, GLFW_KEY_F22 = 311, GLFW_KEY_F23 = 312, 
    GLFW_KEY_F24 = 313, GLFW_KEY_F25 = 314, GLFW_KEY_KP_0 = 320, GLFW_KEY_KP_1 = 321, 
    ...
    GLFW_KEY_KP_DECIMAL = 330, GLFW_KEY_KP_DIVIDE = 331, GLFW_KEY_KP_MULTIPLY = 332, 
    GLFW_KEY_KP_SUBTRACT = 333, GLFW_KEY_KP_ADD = 334, GLFW_KEY_KP_ENTER = 335, 
    GLFW_KEY_KP_EQUAL = 336, GLFW_KEY_LEFT_SHIFT = 340, GLFW_KEY_LEFT_CONTROL = 341, 
    GLFW_KEY_LEFT_ALT = 342, GLFW_KEY_LEFT_SUPER = 343, GLFW_KEY_RIGHT_SHIFT = 344, 
    GLFW_KEY_RIGHT_CONTROL = 345, GLFW_KEY_RIGHT_ALT = 346, GLFW_KEY_RIGHT_SUPER = 347, 
    GLFW_KEY_MENU = 348, GLFW_KEY_LAST = GLFW_KEY_MENU };

typedef std::pair< KeyValue, std::pair< bool, bool >> Key;
